...
function footer(){
  return `<div class="footer">Ritter-Kasse – Version 3.2.1<br>Build 20260630-005<br>© 2026 Jürgen Lindner</div>`;
}
...
function renderSettings(){
  return `<section class="card"><h2>Einstellungen</h2>
    <div class="warning">
      Version 3.2.1 speichert alle Daten weiterhin ausschließlich lokal in diesem Browser auf diesem Gerät.
      Es findet noch keine Synchronisation zwischen mehreren Geräten oder Personen statt.
      Die Menüpunkte unten sind teilweise bereits vorgesehen, aber noch nicht alle aktiv. Die Abrechnung wird ab Version 3.2.1 centgenau mit Ganzzahl-Arithmetik berechnet. Ab Version 3.2.1 zeigt die App bei Restcent-Aufteilungen einen kompakten Hinweis direkt bei den betroffenen Ausgaben an.
    </div>
  </section>
...
console.log("Ritter-Kasse 3.2.1 (Build 20260630-005)");
